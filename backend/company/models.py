...
class Company(BaseAbstractModel):
    ...
    industry = models.ForeignKey(Industry, related_name="company_industry", on_delete=models.DO_NOTHING, limit_choices_to={'is_archived': True}, blank=True, null=True)
    ...
    locality = models.ManyToManyField(Locality, related_name="company_locality", on_delete=models.DO_NOTHING, limit_choices_to={'is_archived': True}, blank=True, null=True)
    country = models.CharField(max_length=255, blank=True, null=True)
    current_employee_estimate = models.CharField(max_length=255, blank=True, null=True)
    keywords = models.ManyToManyField(Keyword, related_name="company_keywords", on_delete=models.DO_NOTHING, limit_choices_to={'is_archived': True}, blank=True, null=True)
